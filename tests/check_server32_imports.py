...
modules = [
    ...
    ("colorsys", ""),
    ("compileall", ""),
    ("compression", "Added in 3.14"),
    ("compression.zstd", "Added in 3.14"),
    ("concurrent", ""),
    ("concurrent.futures", ""),
    ("configparser", ""),
    ("contextlib", ""),
    ...
    ("statistics", ""),
    ("string", ""),
    ("string.templatelib", "Added in 3.14"),
    ("stringprep", ""),
    ("struct", ""),
    ("subprocess", ""),
    ...
    ("tkinter.dialog", "PyInstaller excluded module"),
